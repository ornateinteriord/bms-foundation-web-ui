                    ...
                    {foundMember && (
                        ...
                        >
                            <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
                                ...
                                <Box sx={{ flexGrow: 1 }}>
                                    ...
                                    <Typography variant="caption" color="text.secondary">
                                        @{foundMember.member.username || foundMember.member.Member_id}
                                    </Typography>
                                </Box>
                            ...
                            <Alert severity="success" sx={{ mt: 2 }}>
                                Member found! Click "Start Chat" to begin conversation.
                            </Alert>
                        </Paper>
                    )}

                    {/* Help Text */}
                    {!foundMember && !searching && (
                        <Alert severity="info" sx={{ mt: 2 }}>
                            Enter the mobile number of an active member to start chatting
                        </Alert>
                    )}
                </Box>
            </DialogContent>
